                        ...
                        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mt-8">
                            <div className="bg-linear-to-br from-orange-50 to-orange-100 rounded-xl p-4 border border-orange-200">
                                <div className="flex items-center justify-between">
                                    ...
                                    <div className="w-12 h-12 bg-white rounded-lg flex items-center justify-center shadow-sm relative group-hover:scale-110 transition-transform">
                                        <div className="absolute inset-0 bg-orange-500 rounded-lg opacity-10"></div>
                                        <svg className="w-6 h-6 text-orange-600 relative z-10" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div className="bg-linear-to-br from-purple-50 to-purple-100 rounded-xl p-4 border border-purple-200">
                                <div className="flex items-center justify-between">
                                    <div>
                                        <p className="text-sm font-medium text-orange-500">Tests Taken</p>
                                        <p className="text-2xl font-bold text-orange-800">{progress?.quizzes_taken || 0}</p>
                                    </div>
                                    <div className="w-12 h-12 bg-white rounded-lg flex items-center justify-center shadow-sm relative group-hover:scale-110 transition-transform">
                                        <div className="absolute inset-0 bg-purple-500 rounded-lg opacity-10"></div>
                                        <svg className="w-6 h-6 text-purple-600 relative z-10" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div className="bg-linear-to-br from-blue-50 to-blue-100 rounded-xl p-4 border border-blue-200">
                                <div className="flex items-center justify-between">
                                    ...
                                    <div className="w-12 h-12 bg-white rounded-lg flex items-center justify-center shadow-sm relative group-hover:scale-110 transition-transform">
                                        <div className="absolute inset-0 bg-blue-500 rounded-lg opacity-10"></div>
                            ...
                            <div className="bg-linear-to-br from-green-50 to-green-100 rounded-xl p-4 border border-green-200">
                                <div className="flex items-center justify-between">
                                    ...
                                    <div className="w-12 h-12 bg-white rounded-lg flex items-center justify-center shadow-sm relative group-hover:scale-110 transition-transform">
                                        <div className="absolute inset-0 bg-green-500 rounded-lg opacity-10"></div>
                                        <svg className="w-6 h-6 text-green-600 relative z-10" fill="none" stroke="currentColor" viewBox="0 0 24 24">
