...
function FMGE() {
  ...
  // FMGE Course ID from API
  const COURSE_ID = "f6dd0d25-825f-4c9c-93fe-58cae47378f3";
    ...
    <div className="min-h-screen bg-gray-50 pt-32 pb-20">
      ...
      <section className="relative mb-16">
        <div className="relative h-75 md:h-100 overflow-hidden">
          ...
          />
          <div className="absolute inset-0 bg-linear-to-r from-red-900/95 to-red-800/70 flex flex-col justify-center px-6 md:px-20">
            <div className="animate-fade-in-up">
              <span className="bg-red-500/20 text-red-100 border border-red-400/30 px-4 py-1.5 rounded-full text-sm font-semibold uppercase tracking-wider mb-4 inline-block backdrop-blur-sm">
                Licensing Exam
              </span>
              <h1 className="text-4xl md:text-6xl font-bold text-white mb-4">
                {course?.name || 'FMGE Course'}
              </h1>
            </div>
            <p className="text-red-100 text-lg md:text-xl max-w-2xl animate-fade-in-up delay-100 leading-relaxed">
              {course?.description || 'Comprehensive preparation for the Foreign Medical Graduates Examination. High-yield content designed for success.'}
            </p>
          </div>
        </div>
      </section>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-20 relative z-10">
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-6 mb-10 flex flex-wrap gap-8 items-center justify-between">
          <div>
            <h2 className="text-2xl font-bold text-gray-900">MCI Screening</h2>
            <p className="text-gray-500 text-sm">Focused approach for first-attempt success</p>
          </div>
          ...
          <div className="flex gap-6 text-sm font-medium text-gray-600">
            ...
            <div className="flex items-center gap-2">
              ...
              <div>
                <div className="font-bold text-gray-900">Rapid</div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {subjects.map((subject) => (
              <div
                ...
                className={`group bg-white rounded-2xl p-6 hover:shadow-xl transition-all duration-300 cursor-pointer border border-gray-100 hover:border-red-200 relative overflow-hidden ${!hasAccess ? 'opacity-75' : ''
                  }`}
              >
                <div className="absolute top-0 right-0 w-24 h-24 bg-linear-to-br from-red-50 to-transparent rounded-bl-full opacity-50 group-hover:scale-110 transition-transform -mr-4 -mt-4"></div>
                ...
                <div className="relative z-10">
                  <div className="flex items-start justify-between mb-6">
                    <div className="w-14 h-14 bg-linear-to-br from-red-500 to-red-600 rounded-xl flex items-center justify-center text-white shadow-lg shadow-red-200 group-hover:scale-110 transition-transform duration-300">
                      <span className="text-2xl font-bold">{subject.name.charAt(0)}</span>
                    </div>
                    <span className="bg-red-50 text-red-600 px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wide">
