                    ...
                    <div className="px-8 pb-8">
                        <div className="flex flex-col md:flex-row items-center md:items-end -mt-16 md:-mt-12">
                            ...
                            <div className="relative">
                                <div className="w-32 h-32 rounded-full bg-linear-to-br from-orange-400  flex items-center justify-center text-white text-4xl font-bold shadow-xl border-4 border-white">
                                    {getInitials()}
                                </div>
                                {isEditing && (
                                    <div className="absolute bottom-0 right-0 bg-white rounded-full p-2 shadow-lg">
                                        {/* Image upload not supported by backend yet */}
                                        <svg className="w-5 h-5 text-gray-400 cursor-not-allowed" fill="none" stroke="currentColor" viewBox="0 0 24 24">
